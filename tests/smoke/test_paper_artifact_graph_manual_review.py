...
from scripts.validation.check_paper_artifact_graph_manual_review import (
...
def _make_config(base: Path) -> Path:
    ...
    config_path = base / "configs/paper_artifact_graph_manual_review.yaml"

    line_report = report_dir / "paper_artifact_graph_line_checkpoint_latest.json"
    ...
    _green_optional_report(report_dir / "paper_artifact_graph_package_latest.json", "paper_artifact_graph_package_validation_v1")
    _green_optional_report(report_dir / "paper_artifact_graph_release_candidate_latest.json", "paper_artifact_graph_release_candidate_v1")
    _green_optional_report(report_dir / "paper_artifact_graph_inspection_latest.json", "paper_artifact_graph_inspection_v1")

    config = {
        "schema_version": "paper_artifact_graph_manual_review_config_v1",
        "review": {
...
def test_manual_review_fails_when_required_category_missing(tmp_path: Path) -> None:
    ...
    config["manual_review"]["categories"] = [
        row for row in config["manual_review"]["categories"] if row["id"] != "provider_terms"
    ]
