...
accepted checkpoint = Current Project State Checkpoint v0.2 / Scientific Entity Semantic Prompt Raw-Floor Candidate v0.2c Development Freeze
...
next authorized slice = Fresh v0.2 Held-Out Gate design/freeze
public Qdrant promotion = not performed
public dense/hybrid backend = file
experimental Qdrant serving transport = gRPC
fallback = absent
dataset publication = paused pending redistribution guidance
current entity boundary = v0.2c raw-floor development line complete and frozen on consumed development evidence; raw floor 0.40 produced 1762 predictions, title 0.45 / abstract 0.625 was selected, materialized policy contains 1077 predictions, controlled 24/48/72 comparison gives combined exact F1 0.403677 and consumed-48 exact F1 0.400000 with semantic guardrails passing; candidate is ready for development freeze but not independently accepted; fresh disjoint prediction-blind held-out is next; production/full-corpus remains unauthorized
```
...
9. **Fresh v0.2 Held-Out Gate — next.** Freeze a new disjoint prediction-blind sample and acceptance contract before candidate evaluation; do not tune v0.2c against that sample.
...
current next slice = Fresh v0.2 Held-Out Gate design/freeze
```
