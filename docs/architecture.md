...
fallback = absent
current extension = Safe Canonical Refresh / Operational Orchestration v0.1 / Scientific Entity GLiNER Dev Policy Review v0.1
dataset publication = paused pending redistribution guidance
next accepted functional direction = materialize the frozen title 0.55 / abstract 0.65 GLiNER dev policy under a new immutable candidate build/evaluation identity
```
...
scientific_entity_gliner_frozen_policy_candidate_status = completed_immutable_dev_candidate_validated
scientific_entity_gliner_frozen_policy_candidate_build_id = scientific-entity-gliner-small-v2.5-frozen-policy-v0.1-20260826T102020767519Z
scientific_entity_gliner_frozen_policy_candidate_mentions = 391
scientific_entity_gliner_frozen_policy_rejected_mentions = 155
scientific_entity_gliner_frozen_policy_candidate_validator_checks = 69 / 69
scientific_entity_gliner_frozen_policy_evaluation_id = scientific-entity-evaluation-v0.1-20260826T102636476211Z
scientific_entity_gliner_frozen_policy_evaluation_validator_checks = 69 / 69
scientific_entity_gliner_frozen_policy_exact_precision = 0.401535
scientific_entity_gliner_frozen_policy_exact_recall = 0.360920
scientific_entity_gliner_frozen_policy_exact_f1 = 0.380146
scientific_entity_gliner_frozen_policy_relaxed_f1 = 0.404358
scientific_entity_gliner_frozen_policy_metrics_descriptive_only = true
scientific_entity_gliner_frozen_policy_promotion_sample_sufficient = false
